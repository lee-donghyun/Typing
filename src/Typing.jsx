...
const generateLetters = (mode) => {
    switch (mode) {
        ...
        case '긴 글 연습':
            return '우리는 이에 떨쳐 일어나도다. 양심이 우리와 함께 있으며, 진리가 우리와 함께 나아가는도다. 남녀노소 없이 어둡고 답답한 옛 보금자리로부터 활발히 일어나 삼라만상과 함께 기쁘고 유쾌한 부활을 이루어 내게 되어도다. 먼 조상의 신령이 보이지 않는 가운데 우리를 돕고, 온 세계의 새 형세가 우리를 밖에서 보호하고 있으니 시작이 곧 성공이다. 다만, 앞길의 광명을 향하여 힘차게 곧장 나아갈 뿐이로다.';
    }
}
